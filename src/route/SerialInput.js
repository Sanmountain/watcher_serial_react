...
function SerialInput() {
  ...
  return (
    <form onSubmit={handleFormSubmit}>
      <label>
        <h4>S/N</h4>
        <input type="text" name="dev_serial" value={devSerial} onChange={(e) => setDevSerial(e.target.value)} />
      </label>
      <label>
        <h4>점소코드</h4>
        <input type="text" name="bran_cd" value={branCd} onChange={(e) => setBranCd(e.target.value)} />
      </label>
      <label>
        <h4>업체</h4>
